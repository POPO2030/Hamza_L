...
class ServiceDataTable extends DataTable
{
    ...
    public function html()
    {
        ...
        if (Gate::any(['services.show', 'services.edit', 'services.destroy'])) {
    ...
    protected function getColumns()
    {
        return [
            ...
            // "مجموعه -الخدمات"=>['service_category_id'=>'service_category_id','data'=>'service_category_id'],     
            
            'service_category_id'=>new \Yajra\DataTables\Html\Column([
                'title' => 'المجموعة', 
