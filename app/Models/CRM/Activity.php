...
class Activity extends Model
{
    ...
    {
        return $this->belongsTo('App\Models\CRM\Stage','owner_stage_id');
    }
    ...
    public function get_workOrders()
    {
        return $this->belongsTo('App\Models\CRM\WorkOrder','work_order_id')
        ->select('id','receive_receipt_id','customer_id','product_id','product_count','product_weight','receivable_id');
    }
