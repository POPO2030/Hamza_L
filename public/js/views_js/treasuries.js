document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('create').addEventListener('submit', function(event) {
        ...
        var customerName = document.getElementById('treasuries_name').value;
        var isValid = true;
        ...
        if (customerName.length < 2 || customerName.length > 50) {
            ...
            document.getElementById('treasuries_name').style.borderColor = 'red';
            isValid = false;
        } else {
            document.getElementById('name-error').innerHTML = '';
            document.getElementById('treasuries_name').style.borderColor = '';
        }
    ...
    document.getElementById('treasuries_name').addEventListener('blur', function() {
