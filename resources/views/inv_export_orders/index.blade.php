...
<section class="content-header">
    ...
    <div class="col-sm-6">
        <a class="btn btn-primary float-left btn-sm"
           href="{{ route('invExportOrders.create') }}" id="new_create" style="display:none;">
            عوده
        </a>
    </div>
  </div>
            ...
            <div class="card-body">
                ...
                <div class="arrow-steps clearfix" style="text-align: center;">
                    <div class="step @if($currentStatus == null) current  @endif">
                        {!! Form::open(['route' => ['invExportOrders.index'], 'method' => 'get', 'style'=>'text-align:center; padding-top: 4px;margin-top: 2px;margin-bottom: 0px;']) !!}
                ...
                @include('inv_export_orders.table')
