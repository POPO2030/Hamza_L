...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1><i class="fas fa-people-carry"></i> تعديل المستلم</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::model($receivable, ['route' => ['receivables.update', $receivable->id], 'method' => 'patch','id'=>'create']) !!}
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('receivables.index') }}" class="btn btn-default">إلغاء</a>
            </div>
