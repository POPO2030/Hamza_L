...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1><i class="fas fa-receipt"></i> تعديل على اذن الاضافة</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::model($receiveReceipt, ['route' => ['receiveReceipts.update', $receiveReceipt->id], 'method' => 'patch','enctype'=>'multipart/form-data','id'=>'create']) !!}
...
{{-- form validate --}}
<script src="{{ asset('js/views_js/recevie_receipts_validate_without_image.js') }}"></script>
<script>
