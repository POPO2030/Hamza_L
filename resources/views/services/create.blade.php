...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 ><i class="fas fa-concierge-bell"></i> انشاء خدمات جديده</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::open(['route' => 'services.store', 'id' => 'create', 'onsubmit' => 'return validateForm(event)']) !!}
