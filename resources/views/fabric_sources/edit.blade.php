...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1><i class="fas fa-stamp"></i> تعديل مصدر القماش</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::model($fabricSource, ['route' => ['fabricSources.update', $fabricSource->id], 'method' => 'patch','id'=>'create']) !!}
